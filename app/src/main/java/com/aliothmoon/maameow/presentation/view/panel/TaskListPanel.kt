    ...
    Column(modifier = modifier.width(IntrinsicSize.Max)) {
        ...
        Card(
            ...
            Row(
                ...
                Text(
                    text = if (isProfileMode) stringResource(R.string.done) else stringResource(R.string.edit_config),
        ...
        Card(
            ...
            Row(
                ...
                Spacer(modifier = Modifier.width(6.dp))
                Text(
                    text = if (isEditMode) stringResource(R.string.done) else stringResource(R.string.edit_task),
                    style = MaterialTheme.typography.bodyMedium,
