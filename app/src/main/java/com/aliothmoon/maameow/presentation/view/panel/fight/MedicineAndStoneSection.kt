...
fun MedicineAndStoneSection(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        ...
        CheckBoxWithLabel(
            ...
            label = stringResource(R.string.use_medicine),
        ...
        AnimatedVisibility(visible = config.useMedicine) {
            INumericField(
                ...
                label = stringResource(R.string.medicine_max_n),
                minimum = 0,
                maximum = 999,
                enabled = !config.useStone,
                modifier = Modifier
...
//        UseStoneSection(config, onConfigChange)
        ...
        CheckBoxWithLabel(
            ...
            label = stringResource(R.string.specify_times),
        )
        AnimatedVisibility(visible = config.hasTimesLimited) {
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                INumericField(
                    ...
                    label = stringResource(R.string.fight_n_times),
                    minimum = 0,
                    maximum = 999,
                    modifier = Modifier
                        .fillMaxWidth()
                ...
                if (showSeriesWarning) {
                    Surface(
                        ...
                        Text(
                            text = stringResource(R.string.fight_times_not_divisible, config.maxTimes, config.series),
