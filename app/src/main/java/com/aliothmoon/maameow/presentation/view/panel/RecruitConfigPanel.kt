...
private fun UseExpeditedSection(
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = stringResource(R.string.auto_use_expedited_permit),
                style = MaterialTheme.typography.bodyMedium
            )
        ...
        ExpandableTipContent(
            visible = tipExpanded,
            tipText = stringResource(R.string.use_expedited_tip)
        )
    }
}
...
private fun RecruitMaxTimesSection(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
        Text(
            text = stringResource(R.string.recruit_times),
            style = MaterialTheme.typography.bodyMedium,
        ...
        Text(
            text = stringResource(R.string.recruit_times_tip),
...
private fun SelectExtraTagsSection(
    ...
    val options = listOf(
        "0" to stringResource(R.string.extra_tags_default_none),
        "1" to stringResource(R.string.extra_tags_select_more),
        "2" to stringResource(R.string.extra_tags_rare_only)
    )

    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
        Text(
            modifier = Modifier.padding(vertical = 2.dp),
            text = stringResource(R.string.select_extra_tags_strategy),
            style = MaterialTheme.typography.bodyMedium,
            fontWeight = FontWeight.Medium
        )
...
private fun AutoRecruitFirstListSection(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        ...
        Row(
            ...
            Text(
                text = stringResource(R.string.three_star_tag_tendency),
                style = MaterialTheme.typography.bodyMedium,
                fontWeight = FontWeight.Medium
            )
        ...
        ExpandableTipContent(
            visible = tipExpanded,
            tipText = stringResource(R.string.three_star_tag_tip)
        )
        ...
        Surface(
            ...
            Column(
                ...
                if (config.autoRecruitFirstList.isNotEmpty()) {
                    Text(
                        text = stringResource(R.string.selected_count, config.autoRecruitFirstList.size),
                        style = MaterialTheme.typography.labelSmall,
...
private fun RefreshLevel3Section(
    ...
    Row(
        ...
        Spacer(modifier = Modifier.width(8.dp))
        Text(
            text = stringResource(R.string.auto_refresh_3star_tags),
            style = MaterialTheme.typography.bodyMedium
        )
    }
}
...
private fun ForceRefreshSection(
    ...
    Row(
        ...
        Spacer(modifier = Modifier.width(8.dp))
        Text(
            text = stringResource(R.string.continue_refresh_no_permit),
            style = MaterialTheme.typography.bodyMedium
        )
    }
}
...
private fun NotChooseLevel1Section(
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = stringResource(R.string.manual_confirm_1star),
                style = MaterialTheme.typography.bodyMedium
            )
            ExpandableTipIcon(
                expanded = tipExpanded,
        ...
        ExpandableTipContent(
            visible = tipExpanded,
            tipText = stringResource(R.string.manual_confirm_1star_tip)
        )
    }
}
...
private fun ChooseLevel3Section(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        ...
        Row(
            ...
            Spacer(modifier = Modifier.width(8.dp))
            Text(
                text = stringResource(R.string.auto_confirm_3star),
                style = MaterialTheme.typography.bodyMedium
            )
        }
...
private fun ChooseLevel4Section(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Row(
            ...
            Spacer(modifier = Modifier.width(8.dp))
            Text(
                text = stringResource(R.string.auto_confirm_4star),
                style = MaterialTheme.typography.bodyMedium
            )
        }
...
private fun ChooseLevel5Section(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Row(
            ...
            Spacer(modifier = Modifier.width(8.dp))
            Text(
                text = stringResource(R.string.auto_confirm_5star),
                style = MaterialTheme.typography.bodyMedium
            )
        }
