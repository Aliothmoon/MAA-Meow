...
fun AwardConfigPanel(
    ...
    Column(
        ...
        CheckBoxWithLabel(
            ...
            label = stringResource(R.string.award_daily_weekly)
        )

        CheckBoxWithLabel(
            checked = config.mail,
            onCheckedChange = { onConfigChange(config.copy(mail = it)) },
            label = stringResource(R.string.award_mail)
        )
        ...
        Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
            Row(
                ...
                CheckBoxWithLabel(
                    ...
                    label = stringResource(R.string.award_free_gacha)
                )
            ...
            ExpandableTipContent(
                ...
                tipText = stringResource(R.string.award_free_gacha_tip)
            )
        }
